...
class SearchBot(webdriver.Chrome):
    def __init__(self, driver_path=r"C:\Users\DjolePC\Desktop\search-bot\chromedriver.exe", base_url="https://www.google.com"):
    ...
    def accept_cookie(self):
        ...
        if self.driver.find_elements_by_css_selector('.cli-bar-btn_container'):
